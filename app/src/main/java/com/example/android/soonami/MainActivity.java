...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String USGS_REQUEST_URL =
            "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2016-01-01&endtime=2016-12-01&minmagnitude=7";
    ...
    private class TsunamiAsyncTask extends AsyncTask<URL, Void, Event> {
        ...
        private String makeHttpRequest(URL url) throws IOException {
            ...
            try {
                ...
                //if the request was sucessfully (response code 200),
        ...
        private Event extractFeatureFromJson(String earthquakeJSON) {
            Log.v("json object ", earthquakeJSON.toString());
